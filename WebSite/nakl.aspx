<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="nakl.aspx.cs" Inherits="WebSite.nakl" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 400px">
        <td style="width: 130px">
                <table style="width: 153%">
                    <tr>
                        <td style="width: 190px; height: 25px">Накладная № 300 <asp:Label ID="Nomer" runat="server" Text=""></asp:Label>
                &nbsp;</td>
                ...
                <asp:Button ID="SaveButton" runat="server" Text="Сохранить" OnClick="SaveButton_Click" />
                    ...
                    <tr>
                        <td style="height: 27px" colspan="3">Тип накладной:
                            <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource4" DataTextField="Название_накладной" DataValueField="Код_типа">
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td style="height: 27px" colspan="3">Контрагент: <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="Короткое_имя" DataValueField="Код_контрагента">
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td style="width: 190px" class="auto-style10"><asp:Label ID="Label3" runat="server" Text="Товары"></asp:Label>
                        </td>
                        <td style="width: 77px" class="auto-style10">
                <asp:Button ID="TovarButton" runat="server" Text="Добавить" OnClick="TovarButton_Click" />
                        </td>
                        <td style="width: 259px"><asp:Label ID="Label4" runat="server" Text="Сумма: "></asp:Label>
