<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="index1.aspx.cs" Inherits="WebSite.index1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content">
        ...
        <p>На сайте представлен каталог косметической продукции Косметикс.
            Вы можете оформить заявку и указать все необходимые косметические средства.
        </p>
